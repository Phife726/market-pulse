...
def test_market_report_publisher_is_an_ingestion_code_with_a_label():
    """The pre-scrape market-report gate (2026-09-08). Ingestion owns it — the
    candidate never reaches the scorer."""
