...
8. Enforces `MAX_DAILY_SCRAPES = 150` hard cap and `PIPELINE_DEADLINE_SECONDS = 1800` wall-clock deadline (keeps runtime inside the GitHub Actions 35-min job timeout)
